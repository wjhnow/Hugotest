...
<p class="has-dropcap"> I woke up feeling dull one morning. I really wanted to go to work... but then I took off for the day. Let's say, somewhere out there, another version of me pushed through and showed up anyway.</p>
...
Basic quantum mechanics — the version most people learn, called Copenhagen — says a particle is kind of a blur of possibilities until someone measures it, then the blur "collapses" into one result. That's the standard story everyone gets taught.

Everett just... didn't buy the collapse part. His whole argument was that the math, the Schrödinger equation specifically, works fine without it. You don't need to bolt a collapse onto it by hand.

The wave function of the entire system — this includes the observer too, not just the particle — just keeps evolving, it never actually stops. If you understand that part, the rest kind of follows: what looks like one single outcome from where we're standing is really the universe splitting into multiple versions, each one containing a different result.
...
Normally we assume that when we make a choice, the other option just disappears. It's gone. But this particular reading of quantum mechanics says maybe that's not true. Maybe the universe doesn't erase the path you didn't take. Maybe it just keeps going, somewhere else, on its own branch, separate from yours.
